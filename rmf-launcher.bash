...
then
	...
	ssh -X -i $WEB_IDENTITY_FILE $WEB_MACHINE_NAME ". .profile; nohup ros2 launch rmf_visualization visualization.launch.xml use_sim_time:=$USE_SIM_TIME viz_config_file:=/opt/rmf/src/demonstrations/rmf_demos/rmf_demos/launch/include/office/office.rviz headless:=1 map_name:=$LEVEL_NAME > /root/tailon_logs/current_launch.log &"
